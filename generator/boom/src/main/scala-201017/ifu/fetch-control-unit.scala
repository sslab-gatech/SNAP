  ...
  with HasL1ICacheBankedParameters
{
  ...
  io.imem_req.bits.brDest := f0_brDest
  //yh+end
  ...
  for (i <- 0 until fetchWidth) {
    ...
    f3_fetch_bundle.brDest := f3_imemresp.brDest //yh+
  ...
  //yh+begin
  fb.io.startAddr := io.startAddr
  fb.io.endAddr := io.endAddr
  fb.io.enableBRQ := io.enableBRQ
  fb.io.enableBrDest := io.enableBrDest

  //printf("YH+ fb.io.startAddr: %d fb.io.endAddr: %d\n",
  //          fb.io.startAddr, fb.io.endAddr)
  //yh+end
