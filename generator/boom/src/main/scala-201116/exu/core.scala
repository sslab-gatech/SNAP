...
//      ("DTLB miss",   () => io.dmem.perf.tlbMiss),
  ...
  //csr.io.totalMissCnt := io.lsu.totalMissCnt
  //csr.io.htMissCnt := io.lsu.htMissCnt
  ...
  //io.lsu.ht_config.totalMissCnt := custom_csrs.totalMissCnt
  //io.lsu.ht_config.htMissCnt := custom_csrs.htMissCnt
